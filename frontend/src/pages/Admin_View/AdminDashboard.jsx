...
const AdminDashboard = () => {
    useEffect(() => {
        ...
        const ensureLink = (rel, sizes) => {
            ...
            l.setAttribute('href', String(umsLogo));
            return l;
        };
    ...
    const tiles = [
        ...
        { title: 'Administration (Settings & Roles)', icon: Icon.admin, accent: 'royal' },
        { title: 'Requests & Approvals', icon: Icon.requests, accent: 'citrus' },
        { title: 'Announcements & Events', icon: Icon.announcements, accent: 'rose' }
    ];
    ...
    return (
        <div className="shell">
            ...
            <main className="main" role="main">
                ...
                <div className="grid">
                    {tiles.map((t) => (
                        <Link to={t.path || '#'} className="card" key={t.title} data-accent={t.accent}>
                            <div className="card-title">
                                <div>
                                    <div className="card-heading">{t.title}</div>
                                </div>
                                {t.icon && (
                                    <div className="card-icon" aria-hidden="true" data-accent={t.accent}>
                                        {t.icon}
                                    </div>
                                )}
                            </div>

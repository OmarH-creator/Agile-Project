...
const toBackendFormat = student => {
    ...
    console.log('🔍 toBackendFormat - Input student:', student);
    console.log('🔍 toBackendFormat - Birthdate value:', student.birthdate);

    if (student.birthdate) {
        // Ensure the date is in the correct format for backend
        // Your logs show it's already in YYYY-MM-DD format
        formattedDateOfBirth = student.birthdate;

        console.log('🔍 toBackendFormat - Setting dateOfBirth to:', formattedDateOfBirth);
    } else {
        console.log('🔍 toBackendFormat - No birthdate provided');
    }
...
const toFrontendFormat = backendStudent => {
    ...
    if (backendStudent.dateOfBirth) {
        if (backendStudent.dateOfBirth.includes('T')) {
            // ISO date with time
            const date = new Date(backendStudent.dateOfBirth);
            if (!isNaN(date.getTime())) {
                birthdate = date.toISOString().split('T')[0];
            }
        } else if (backendStudent.dateOfBirth.includes('-')) {
            // Already in YYYY-MM-DD format
            birthdate = backendStudent.dateOfBirth;
        } else {
...
const Icon = {
    student: <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        <path d="M3 7l9-4 9 4-9 4-9-4z" />
        <path d="M12 11v6" />
        <path d="M6 13.5c1.8 1.2 3.8 1.8 6 1.8s4.2-.6 6-1.8" />
        <path d="M18 9l3 1.5-3 1.5" />
    </svg>,
    facilities: <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    analytics: <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
        <path d="M3 3v18h18" />
        <rect x="7" y="12" width="3" height="6" rx="1" />
        <rect x="12" y="9" width="3" height="9" rx="1" />
        <rect x="17" y="6" width="3" height="12" rx="1" />
    </svg>,
    requests: <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    menu16: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M4 6h16M4 12h16M4 18h16" /></svg>,
    home16: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 12l9-8 9 8" /><path d="M5 10v10h14V10" /></svg>,
    help16: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M9.1 9a3 3 0 0 1 5.8 1c0 1.5-1 2.2-1.8 2.8-.7.5-1.1.9-1.1 1.7V15" /><circle cx="12" cy="18" r="0.5" /></svg>,
    bell16: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8a6 6 0 1 0-12 0c0 7-3 7-3 7h18s-3 0-3-7" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /></svg>,
    ...
    user16: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>,
    plus16: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14M5 12h14" /></svg>,
    edit16: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M17 3a2.8 2.8 0 0 1 4 4L7 21l-4 1 1-4Z" /><path d="m15 5 4 4" /></svg>,
    trash16: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 6h18" /><path d="M8 6V4h8v2" /><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6" /><path d="M10 11v6M14 11v6" /></svg>,
    download16: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3v12" /><path d="m7 12 5 5 5-5" /><path d="M5 21h14" /></svg>,
    check16: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg>,
    close16: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="m4 4 16 16M20 4 4 20" /></svg>,
    spinner: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="spinner">
        <path d="M21 12a9 9 0 1 1-6.219-8.56" />
    </svg>
};

// Loading Spinner Component
const LoadingSpinner = ({ size = 'medium', message = 'Loading...' }) => <div className={`loading-spinner ${size}`}>
    {Icon.spinner}
...
const ErrorMessage = ({ error, onDismiss }) => {
    ...
    return <div className="error-message" role="alert">
        ...
        {onDismiss && <button type="button" className="ghost-btn" onClick={onDismiss} aria-label="Dismiss error">
                {Icon.close16}
            </button>}
    </div>;
};
...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        console.log('Delete modal state:', {
            showDeleteConfirm,
            deleteTarget,
            isModalVisible: showDeleteConfirm && deleteTarget
        });
    ...
    const handleFormSubmit = async event => {
        ...
        console.log('📋 Form data before conversion:', normalized);
        console.log('📅 Birthdate in form:', normalized.birthdate);
        console.log('📅 Type of birthdate:', typeof normalized.birthdate);
        ...
        if (formMode === 'edit' && selectedStudent) {
            ...
            try {
                ...
                const backendData = toBackendFormat(normalized);
                await updateStudent(selectedStudent.code, backendData);
                    ...
                    prev.map(student =>
                        student.code === selectedStudent.code
                            ? {
                                ...student,
                                ...normalized,
                                code: student.code, // Keep original code (shouldn't change)
                                academicHistory: student.academicHistory,
                                currentRegistrations: student.currentRegistrations ?? [],
                                holds: student.holds ?? []
                            }
    ...
    const handleDeleteStudent = async code => {
        ...
        try {
            ...
            setShowDeleteConfirm(false); // hide modal after deletion
        } catch (err) {
    ...
    return <div className="shell">
        ...
        <main className="main" role="main">
            <div className="page-header">
                ...
                {isStudentView && <div className="page-actions">
                        <button
                            type="button"
                            className="ghost-btn"
            ...
            {isStudentView && <section className="dashboard-content">
                    ...
                    <aside className="student-panel">
                        ...
                        <div className="student-list" role="list">
                            {initialLoading && <div className="empty-state">
                                    <LoadingSpinner size="medium" message="Loading..." />
                                </div>}

                            {!initialLoading && filteredStudents.length === 0 && <div className="empty-state">
                                    {students.length === 0
                                        ? 'No students found.'
                                        : 'No match.'}
                                </div>}

                            {!initialLoading && filteredStudents.map(student => <button
                                    type="button"
                                    key={student.code}
                    ...
                    <section className="detail-panel">
                        {(loading || initialLoading) && <div className="empty-state large">
                                <LoadingSpinner size="large" />
                            </div>}

                        {!loading && !initialLoading && !selectedStudent && <div className="empty-state large">
                                    ...
                                    <header className="detail-card-header">
                                        ...
                                        <div className="detail-actions">
                                            ...
                                            <button
                                                ...
                                                onClick={() => {
                                                    console.log('showDeleteConfirm:', showDeleteConfirm, 'deleteTarget:', deleteTarget);
                                                    setDeleteTarget(selectedStudent.code);
                                ...
                                <article className="history-card">
                                    ...
                                    <div className="history-table-wrapper">
                                        <table className="history-table">
                                            ...
                                            <tbody>
                                            {(selectedStudent.academicHistory ?? []).map(record => <tr key={`${record.code}-${record.term}`}>
                                                    <td>{record.code}</td>
                                                    <td>{record.title}</td>
                                ...
                                <article className="registration-card">
                                    ...
                                    <div className="registration-grid">
                                        <div className="eligible-courses">
                                            ...
                                            <div className="course-scroll">
                                                {availableCourses.length === 0 && <div className="empty-state small">
                                                        No courses available.
                                                    </div>}
                                                {availableCourses.map(course => <article className="course-option" key={course.code}>
                                                        <header>
                                                            <div>
                                                        ...
                                                        <div className="course-meta">
                                                            {(course.prerequisites ?? []).map(prerequisite => <span key={`${course.code}-${prerequisite}`} className="prereq-chip met">
                                                                    {prerequisite}
                                                                </span>)}
                                                        </div>
                                                        <button
                                        ...
                                        <div className="pending-panel">
                                            ...
                                            <div className="pending-list">
                                                {pendingRegistration.length === 0 && <div className="empty-state small">
                                                        No courses selected.
                                                    </div>}
                                                {pendingRegistration.map(course => <div className="pending-item" key={`pending-${course.code}`}>
                                                        <div>
                                    ...
                                    <div className="current-registrations">
                                        ...
                                        <div className="registration-list">
                                            {(selectedStudent.currentRegistrations ?? []).length === 0 && <div className="empty-state small">
                                                    No active registrations.
                                                </div>}
                                            {(selectedStudent.currentRegistrations ?? []).map(course => <div className="registration-item" key={`active-${course.code}`}>
                                                    <div>
                                                        <strong>{course.code}</strong>
                                                        <span>{course.title}</span>
                                                    </div>
            ...
            {!isStudentView && <div className="grid">
                    {tiles.map(tile => tile.mode === 'students' ? <div
                                key={tile.title}
                                className="card"
                            ...
                            >
                                <div className="card-title">
                                    ...
                                    {tile.icon && <div className="card-icon" aria-hidden="true" data-accent={tile.accent}>
                                            {tile.icon}
                                        </div>}
                                </div>
                            </div> : <Link
        ...
        {formMode && <div className="modal-backdrop">
                <div className="modal">
                    {/* HEADER */}
                    ...
                    <div className="modal-body">
                        <form id="studentForm" onSubmit={handleFormSubmit}>
                            <div className="form-grid">
                                <label>
                                    ...
                                    <input name="code" value={formData.code} onChange={handleFormChange} required
                                ...
                                <label>
                                    <span>Hours</span>
                                    <input name="completedHours" value={formData.completedHours}
                                           onChange={handleFormChange}/>
                                </label>
                                <label>
                                    <span>Fees</span>
                                ...
                                <label>
                                    ...
                                    <input name="militaryStatus" value={formData.militaryStatus}
                                           onChange={handleFormChange}/>
                                </label>
                        ...
                        {validationError && <p className="form-error" style={{marginTop: '1rem'}}>{validationError}</p>}
                    </div>
        ...
        {showDeleteConfirm && deleteTarget && (
            <div className="modal-backdrop" role="dialog" aria-modal="true" style={{ zIndex: 10000 }}>
                <div className="modal">
                    <header className="modal-header">
                    ...
                    <div className="modal-body">
                        <p>
                            Are you sure you want to remove student <strong>{deleteTarget}</strong> and their academic record?
                        </p>
                    </div>
                    <footer className="modal-footer">
                        <button
                        ...
                        <button
                            ...
                            disabled={loading}
                        >
                            {loading ? Icon.spinner : Icon.trash16}
